   ...
   do
      ...
      then
         ...
         do
            for N in ${NUM_INT_NS};
            do
               if [ ! -s ${RESULTDIR}/mpi_manager_worker_${N}_${INTEN}_${NP}_${P} ] ;
               then
                  echo ERROR: ${RESULTDIR}/mpi_manager_worker_${N}_${INTEN}_${NP}_${P} not found 
   ...
   do
      ...
      then
         ...
         do
            ...
            do
		echo ${N} \
		     $(cat ${RESULTDIR}/mpi_manager_worker_${N}_${INTEN}_1_2)\
		     $(cat ${RESULTDIR}/mpi_manager_worker_${N}_${INTEN}_${NP}_${P})
